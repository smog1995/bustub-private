...
class BPlusTreeLeafPage : public BPlusTreePage {
 public:
  ...
  auto Find(const KeyType &key, std::vector<ValueType> *result, KeyComparator &comparator) -> bool;
  ...
  auto Find(const KeyType &key, KeyComparator &comparator) -> bool;
  void CopyToArray(MappingType *array);
  void Delete(const KeyType &key, KeyComparator &comparator);
  void MergeInLeaf(MappingType *array, int array_size);
